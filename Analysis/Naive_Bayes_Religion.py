#Analysis with Religion using Naive Bayes
import numpy as np
...
# Decision: Due to lack of lowest data set our accuracy was also low. If we can enlarge the data set and balance our data set for every religion only then our accuracy will increase.
