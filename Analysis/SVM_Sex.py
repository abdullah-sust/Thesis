#Analysis with Sex using Support Vector Machine
import numpy as np
...
# Decision:
# Due to lack of data set it was difficult for us to classify with our classifier. Further, SVM is a binary classifier. So we need to train with more data set.