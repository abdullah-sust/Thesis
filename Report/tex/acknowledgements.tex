...
% and providing erroneous reads as well as reference data of  \emph{E. Coli}.  
...
%to the \emph{JabRef Development Team} for supporting us to manage references with such an interesting tool called \emph{JabRef}\cite{JabRef_software}.
\end{document}
